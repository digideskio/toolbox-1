...
For first-time R users, I recommend reading the sections of this website in order (from left to right in the above navigation bar.) After getting to know the tools, the topics are introduced following a typical data-analytic workflow: From importing data to data wrangling visualization.
...
# [Data wrangling: Questionnaire data](questionnaire.html)
