...
```{r}
head(read.csv("data/big5/data.csv", sep = "\t"))
```
...
Much better! Now we can immediately see meaningful values of race, gender, etc. See [here](multisource.html#Bonus_round) for how to change the two-letter country codes to actual country names.
